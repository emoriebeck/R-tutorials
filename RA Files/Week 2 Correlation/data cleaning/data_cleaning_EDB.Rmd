...
wd <- "~/Dropbox (Brown)/Summer 2018/RA Files/Week 2 Correlation/data cleaning"
...
file <- sprintf("%s/home_w1_redacted.csv", wd)
...
codebook <- sprintf("%s/Codebook.xlsx", wd) %>% readxl::read_xlsx()
