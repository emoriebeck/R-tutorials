...
## Create Composites   
Now that we have reverse coded our items, we can create composites of our scales -- in this case, the Big 5. 
...
To do this, I'm going to use a mix of the tidyverse. At first glance, it may seem complex but as you move through other tutorials (particularly the `purrr` tutorial), it will begin to make much more sense.  
